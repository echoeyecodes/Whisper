  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-dark-border bg-transparent hover:bg-dark-bg-tertiary hover:text-dark-text-primary",
        secondary:
          "bg-dark-bg-secondary text-dark-text-primary hover:bg-dark-bg-tertiary",
        ghost: "hover:bg-dark-bg-tertiary hover:text-dark-text-primary",
